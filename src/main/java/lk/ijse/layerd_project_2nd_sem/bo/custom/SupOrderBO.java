...
public interface SupOrderBO extends SuperBO {
    ...
    boolean placeOrder(String orderId, LocalDate orderDate, String supplierId, List<SupOrderDetailDTO> supOrderDetail) throws SQLException, ClassNotFoundException;
